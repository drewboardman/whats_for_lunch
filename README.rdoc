...
* We need a way to add new restaurants to our app's database
    The add feature is available on the bottom of the dashboard show view(root) and also in a 
    link at the top navbar. Restaurants added do not belong to a single user and can be seen 
    by all users.
